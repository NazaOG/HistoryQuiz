    ...
    this.state = {
      quizzes: [

        {
          ...
          subQuiz: [
            {
              name: 'Quiz 1', questions: '4', time: '5 min', score: false,
              qArr: [
                {
                  question: "5 + 5 = ?",
                  option1: "10",
            ...
            {
              name: 'История Кыргызстана', questions: '3', time: '5 min', score: false,
              qArr: [
                {
                  question: "Кто изначально проживал на территории Киргизии?",
                  option1: "Скифы",
                  option2: "Викинги",
                  option3: "Варяги",
                  answer: "1"
                ...
                {
                  question: "Входила ли Киргизия в СССР?",
                  option1: "ДА",
                  option2: "НЕТ",
                  option3: "Неизвестно",
                  answer: "1"
                },
                {
                  ...
                  question: "Какая валюта в Киргизии?",
                  option1: "РУБЛЬ",
                  option2: "ТЕНГЕ",
                  option3: "СОМ",
                  option4: "ДОЛЛОРЫ",
